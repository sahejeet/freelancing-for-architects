...
window.location.href = 'http://localhost/freelancing/index.php/test/logout'; }
...
<div class="logoo">
 ...
 <a class="n" href="http://localhost/freelancing/index.php/test/logout" onclick="preventBack()">LOGOUT</a>

<a class="n" href="http://localhost/freelancing/index.php/test/hirer_profile" onclick=""  >MY PROFILE</a>

 <a class="n" href="http://localhost/freelancing/index.php/test/inbox_hirer" onclick=""  >INBOX</a>
<a class="n" href="http://localhost/freelancing/index.php/test/new_project">START NEW PROJECT</a>
<a class="n" href="http://localhost/freelancing/index.php/test/my_projects">MY PROJECTS</a> 

<a class="n" href="http://localhost/freelancing/index.php/test/proposals" onclick=""  >PROPOSALS</a>
...
echo 'Hello';
echo '&nbsp;';
echo '<a href="http://localhost/freelancing/index.php/test/hirer_profile"><b>';
echo $username;
echo '</b></a>';
