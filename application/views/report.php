...
$this->session->set_userdata('idq',$us);
//echo $us;
...
$banda=$row->USERNAME;
$this->session->set_userdata('banda',$banda);
...
<form action="http://localhost/freelancing/index.php/test/report_insert" method="post" onsubmit="return checkform(this)" id="myform">
<p align="center">
...
<input type="submit" class="button button2" onclick="" value="Report"               name="button" ><br>
</td>
</tr>
